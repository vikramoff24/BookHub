...
import com.vikram.bookhub.adapter.DashboardRecyclerAdapter
import com.vikram.bookhub.model.Book
...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // progressLayout=view.findViewById(R.layout.progressLayout)
        // progressBar=view.findViewById(R.layout.progressBar)
...
val settingsIntent=Intent(Settings.ACTION_WIRELESS_SETTINGS)
        ...
        setHasOptionsMenu(true) //only for setting icon in fragment
        return view
